            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <section class="bg-card border border-border rounded-xl shadow-sm p-6">
                    ...
                    @forelse($jobListings as $job)
                        <a href="{{ route('jobs.show', $job->id) }}" class="block border border-border rounded-lg p-4 mb-3 last:mb-0 hover:border-primary/30 hover:bg-secondary/30 transition-all">
