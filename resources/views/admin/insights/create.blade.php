    ...
    <div class="max-w-[1200px] mx-auto pt-16">
        <div class="py-12 px-6 md:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-foreground mb-2">Create Career Insight</h1>
                    <p class="text-muted">Add a new career insight entry to the platform.</p>
                </div>
                <a
                ...
                <form method="POST" action="{{ route('admin.insights.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="trend" {{ old('type') === 'trend' ? 'selected' : '' }}>Trend</option>
